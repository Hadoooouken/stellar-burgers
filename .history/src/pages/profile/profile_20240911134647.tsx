...
export const Profile: FC = () => {
  ...
  const [updateUserError, setUpdateUserError] = React.useState<string | undefined>(
    undefined
  );
  ...
  return (
    <ProfileUI
      ...
      isEditing={isEditing}
      setIsEditing={(newState) => dispatch(setIsEditing(newState))} // Передача функции обновления состояния редактирования
    />
  );
};
