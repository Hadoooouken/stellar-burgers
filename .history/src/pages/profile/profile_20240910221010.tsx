...
export const Profile: FC = () => {
  ...
  const [isEditMode, setIsEditMode] = useState<boolean>(false); // Флаг для управления режимом редактирования
  ...
  return (
    <ProfileUI
      ...
      handleEditClick={handleEditClick} // Передаем обработчик редактирования
      isEditMode={isEditMode} // Передаем состояние редактирования
    />
  );
};
