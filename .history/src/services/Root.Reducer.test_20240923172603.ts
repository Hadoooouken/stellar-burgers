import rootReducer from './path/to/rootReducer'; // Убедитесь, что путь правильный
import { IConstructorState } from '../services/slices/ConstructorSlice'; // Импортируйте интерфейсы
import { IIngredientsState } from '../services/slices/IngredientsSlice';
