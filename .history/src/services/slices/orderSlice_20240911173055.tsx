...
import { clearConstructor } from './constructorSlice'; // Импорт экшена для очистки конструктора
...
export const createOrder = createAsyncThunk<TOrder, string[], { dispatch: any }>(
  'order/create',
