...
describe('constructorSlice reducer', () => {
    ...
    it('should move ingredient up', () => {
        const initialState = {
            bun: null,
            ingredients: [
                { id: '1', _id: '1', name: 'ing1', type: 'main', price: 100, proteins: 0, fat: 0, carbohydrates: 0, calories: 0, image: '', image_large: '', image_mobile: '' } as TConstructorIngredient,
                { id: '2', _id: '2', name: 'ing2', type: 'main', price: 100, proteins: 0, fat: 0, carbohydrates: 0, calories: 0, image: '', image_large: '', image_mobile: '' } as TConstructorIngredient,
            ],
        };
