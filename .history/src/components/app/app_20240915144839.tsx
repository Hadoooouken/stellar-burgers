...
// import { getUser } from '../../services/slices/UserSlice';
// import { getIngredients } from '../../services/slices/IngredientsSlice'; // Исправлено: импортируем getIngredients
...
//   useEffect(() => {
//     dispatch(getIngredients()); // Исправлено: используем thunk-экшен getIngredients
//     dispatch(getUser());
//   }, [dispatch]);
