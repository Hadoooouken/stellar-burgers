...
const App = () => {
  ...
  // Получаем backgroundLocation, если модальное окно было открыто на предыдущей странице
  ...
  return (
    <div className={styles.app}>
      ...
      {/* Определяем, отображать ли модальное окно или полную страницу */}
      ...
      {/* Модальные окна, если есть backgroundLocation */}
      {backgroundLocation && (
        <Routes>
          <Route
            path='/feed/:number'
