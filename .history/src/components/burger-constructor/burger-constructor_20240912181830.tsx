...
import { nanoid } from 'nanoid'; // Используем nanoid для генерации уникального id
...
const constructorSlice = createSlice({
  ...
  reducers: {
    ...
    // Используем prepare для добавления уникального id к ингредиентам
    addIngredient: {
      reducer: (state, action) => {
        state.ingredients.push(action.payload);
      },
      prepare: (ingredient: TIngredient) => ({
        payload: { ...ingredient, id: nanoid() } // Обогащаем данные id
      })
    },
