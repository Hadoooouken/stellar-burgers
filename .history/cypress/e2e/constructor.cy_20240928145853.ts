...
//       cy.get('[data-testid=category-bun]').contains('Добавить').click();
//       cy.get('.constructor-element_pos_top')
//         .contains('Флюоресцентная булка R2-D3') // Изменено название булки
//         .should('exist');
//     });
...
//       cy.get('[data-testid=category-main]').contains('Добавить').click();
//       cy.get('.constructor-element')
//         .contains('Мясо бессмертных моллюсков Protostomia') // Изменено название котлеты
//         .should('exist');
//     });
...
//       cy.contains('Выберите начинку').should('exist');
//       cy.get('[data-testid=category-sauce]').contains('Добавить').click();
//       cy.get('.constructor-element').contains('Соус традиционный галактический') // Изменено название соуса
//         .should('exist');
//     });
//   });
...
//       cy.get('[data-testid=category-bun] li').first().click();
//       cy.get('[id=modals]')
//         .contains('Флюоресцентная булка R2-D3') // Изменено название булки в модалке
//         .should('be.visible');
//       cy.get('[id=modals]').find('button').click().should('not.exist');
//     });
//   });
