describe('BurgerConstructor', () => {
  beforeEach(() => {
    ...
    cy.intercept('POST', 'api/orders', { fixture: 'mockOrder.json' }).as('makeOrder');
  ...
  describe('Initial State', () => {
    it('should display an empty constructor', () => {
  ...
  describe('Adding Ingredients', () => {
    it('добавляет булку в конструктор', () => {
      cy.get('.bun-category').contains('Добавить').click();
...
//       'getUser'
//     );
//     cy.viewport(3840, 2160); // Установка размера окна
//     cy.setCookie('accessToken', 'testToken');
//     localStorage.setItem('refreshToken', 'testRefreshToken');
