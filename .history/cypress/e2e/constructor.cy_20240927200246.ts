describe('BurgerConstructor', () => {
  ...
  describe('Adding Ingredients to Constructor', () => {
    it('should allow adding buns to the constructor', () => {
      ...
      cy.get('.constructor-element_pos_top')
        .contains('Флюоресцентная булка R2-D3') // Замена на актуальную булку
        .should('exist');
    });
    ...
    it('should allow adding main ingredients to the constructor', () => {
      ...
      cy.get('.constructor-element')
        .contains('Мясо бессмертных моллюсков Protostomia') // Замена на актуальный основной ингредиент
        .should('exist');
    });
    ...
    it('should allow adding sauce ingredients to the constructor', () => {
      ...
      cy.get('.constructor-element')
        .contains('Соус Spicy-X') // Замена на актуальный соус
        .should('exist');
    });
  });
  ...
  describe('Ingredient Modal', () => {
    it('should open and close the ingredient modal', () => {
      ...
      cy.get('[id=modals]')
        .contains('Флюоресцентная булка R2-D3') // Замена на актуальный ингредиент
        .should('be.visible');
