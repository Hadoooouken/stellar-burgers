describe('BurgerConstructor', () => {
  ...
  describe('Adding Ingredients to the Constructor', () => {
    it('should add buns to the burger', () => {
      ...
      cy.get('[data-testid=category-bun]').find('button').contains('Добавить').click();
    ...
    it('should add main ingredients to the burger', () => {
      ...
      cy.get('[data-testid=category-main]').find('button').contains('Добавить').click();
    ...
    it('should add sauces to the burger', () => {
      cy.contains('Выберите начинку').should('exist');
      cy.get('[data-testid=category-sauce]').find('button').contains('Добавить').click();
      cy.get('.constructor-element').find('span').contains('Соус Spicy-X').should('exist');
    });
  });
