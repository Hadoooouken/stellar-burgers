describe('BurgerConstructor', () => {
  beforeEach(() => {
    ...
    cy.intercept('POST', 'api/orders', { fixture: 'mockOrder.json' }).as('placeOrder');
    cy.intercept('GET', 'api/auth/user', { fixture: 'mockUser.json' }).as('loadUser');
  ...
  describe('Adding ingredients to constructor', () => {
    it('should include selected buns in the constructor', () => {
    ...
    it('should incorporate main ingredients into the constructor', () => {
  ...
  describe('Ingredient Details Modal', () => {
    it('should display and allow closing ingredient details', () => {
  ...
  describe('Order Creation Process', () => {
    ...
    it('should complete the order successfully', () => {
      ...
      cy.wait('@placeOrder', { timeout: 4000 })
