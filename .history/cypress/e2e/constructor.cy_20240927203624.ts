describe('BurgerConstructor Tests', () => {
  beforeEach(() => {
    cy.intercept('GET', 'api/ingredients', { fixture: 'ingredientsMock.json' });
    cy.intercept('POST', 'api/orders', { fixture: 'orderMock.json' }).as('placeOrder');
    cy.intercept('GET', 'api/auth/user', { fixture: 'userMock.json' }).as('fetchUser');
