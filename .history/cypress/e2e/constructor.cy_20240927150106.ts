...
describe('Burger Constructor Page', () => {
  ...
  it('should handle ingredient loading correctly', () => {
    // Ожидаем, что хотя бы одна категория ингредиентов появится
    cy.get('[data-testid="category-bun"]', { timeout: 10000 }).should('exist');
  });
});
