describe('Burger Constructor Page', () => {
  ...
  it('should display ingredients and add them to constructor', () => {
    ...
    cy.get('[data-testid="ingredient-bun"]').first().drag('[data-testid="constructor-drop-area"]');
    cy.get('[data-testid="constructor-bun"]').should('contain', 'верх');
    
    // Добавляем начинки
    cy.get('[data-testid="ingredient-main"]').first().drag('[data-testid="constructor-drop-area"]');
